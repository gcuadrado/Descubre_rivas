...
public class PuentedeArganda extends PuntoDeInteres {
    public PuentedeArganda() {
        ...
        this.info_detallada = "El incremento de mercancías hacia la capital procedente de Valencia y del " +
                "Levante se incrementó a partir del siglo XVIII.\n\n En el siglo XV se utilizaban unas barcas " +
                "de propiedad conjunta entre el Rey y la villa de Arganda, y posteriormente compartidas entre " +
                ...
                "de 1831 cuando se desploma y no es construido de nuevo.\n\n" +
